...
const CadastroServico = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        const response = await axios.post("http://localhost:5000/servicos", novoServico); // Endpoint correto para serviço
  ...
  return (
    <div className="bg-gray-800 flex justify-center items-center" style={{ minHeight: 'calc(100vh - 72px)' }}>
      <div className="bg-gray-700 text-white p-8 rounded-lg shadow-lg w-full max-w-lg">
        <h1 className="text-3xl font-semibold text-center mb-6">Cadastrar Serviço</h1>
