    ...
    return (
        <>
            ...
            <main className="bg-gray-800 text-white min-h-screen p-6">
                <h1 className="text-5xl font-semibold mb-6 text-center">Serviços</h1>
                ...
                <table className="min-w-full bg-gray-700 shadow-lg overflow-hidden mb-6">
                    ...
                    <tbody>
                        {["Depilação", "Manicure", "Limpeza de pele", "Pintura de Cabelo"].map((servico, index) => (
                            <tr key={index} className="hover:bg-gray-600 border-t border-gray-500">
                                <td className="px-6 py-4 border-r border-gray-500">{servico}</td>
                                <td className="px-6 py-4 border-r border-gray-500">Descrição do {servico}</td>
                                ...
                                <td className="px-6 py-4 border-r border-gray-500">
                                    <Link to={'/servicos/Editar/${servicoId}'}>
